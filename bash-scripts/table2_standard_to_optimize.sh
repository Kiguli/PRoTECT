...
find ../ex/benchmarks-stochastic -type f -exec sed -i "s/'optimize': False/'optimize': True/g" {} +
find ../ex/benchmarks-stochastic -type f -exec sed -i "s/'lam': None,/'lam': 10,/g" {} +
find ../ex/benchmarks-stochastic -type f -name "ex2_van_der_pol_oscillator_dt_SS_uniform.py" -exec sed -i "s/'lam': 10,/'lam': 1000,/g" {} +
